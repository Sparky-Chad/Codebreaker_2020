...
class Signal_Analysis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Signal_Analysis")
        ...
        # Variables
        ##################################################
        self.variable_0 = variable_0 = [0.2,0.9]
        self.sps = sps = 4
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/lapech/Desktop/CodeBreaker/6_Task/signal.cf32', True, 0, 0)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.digital_cma_equalizer_cc_0, 0))
...
def main(top_block_cls=Signal_Analysis, options=None):
